%% MIE377 (Winter 2021) - Project 1
% 
% The purpose of this program is to provide a template with which to
% develop Project 1. The project requires you to test different models 
...
factorData = 'MIE377_FactorReturns.csv';
...
for t = 1 : NoPeriods
    ...
    %----------------------------------------------------------------------
    x(:,t) = Project1_Function(periodReturns, periodFactRet, x0(:,t));
